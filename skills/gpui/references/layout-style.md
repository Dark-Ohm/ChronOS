...
**Not applicable to this repo** — `gpui_component` is not a workspace
dependency here (check `Cargo.lock` before reaching for these); use plain
`div().flex()...` instead, as the rest of this codebase does.
