<!-- T044 — migrated 2026-07-22 from docs/orchestration/report-log/hermes-report-12b-confusion.md — see docs/orchestration/tasks/MIGRATION.md -->
...
- Архивная копия этого отчёта (до дополнения №13/№14):
  `docs/orchestration/report-log/hermes-report-12.md`.
