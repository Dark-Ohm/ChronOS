<!-- T099 — migrated 2026-07-22 from docs/orchestration/report-log/zed-report-7.md — see docs/orchestration/tasks/MIGRATION.md -->
...
**Grim:** `docs/orchestration/reports/zed-udisks-smoke/dp1-full.png` (+ `panel-crop.png`, `disks-section.png`). На DP-1: три живые карточки (nvme0n1p2 / Ventoy / VTOYEFI), internal без action-row.
