<!-- T079 — migrated 2026-07-22 from docs/orchestration/report-log/grok-report-17.md — see docs/orchestration/tasks/MIGRATION.md -->
...
- **Source:** без коммитов.
- Отчёт: `docs/orchestration/reports/grok-report-17.md` (`docs/orchestration/` в `.gitignore` — active report, не в git).
