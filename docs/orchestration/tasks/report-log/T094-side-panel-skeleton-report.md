<!-- T094 — migrated 2026-07-22 from docs/orchestration/report-log/hermes-report-7.md — see docs/orchestration/tasks/MIGRATION.md -->
...
# grim: docs/orchestration/reports/hermes-7-smoke/open-crop.png — skeleton text
