...
**Замечен посторонний коммит `98bd08fc` (feat T265-A) прямо в master
16:50:13, между двумя моими коммитами той же сессии** — параллельная
сессия закоммитила напрямую, без report/inbox и без моей приёмки, хотя
T265-A числилась BLOCKED цепочкой до закрытия T275/T265-launcher. Дерево
после него чистое (без диффа), но код НЕ проверен мной — следующая
сессия обязана его сверить как обычный вход, не доверять на слово.
