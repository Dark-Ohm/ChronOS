...
T265-H **готова к выдаче.** Канон `docs/design/chronos-start-menu.html`.
Якорь вниз от верхней Start-кнопки, не низ экрана. Overlay + закрыть
левую панель. Не параллелить с T287-A. T287-B в дереве грязный — не трогал.
