...
- [ ] **Step 1: Locate the existing `font_mono` field and its default**
...
- [ ] **Step 4: Add the field next to `font_mono`**
...
- [ ] **Step 6: Full crate build to confirm no other construction site broke**

Run: `cargo build -p chronos-ui -p chronos-app`
