<!-- T017 — SUPERSEDED draft, migrated 2026-07-22 from docs/orchestration/report-log/mimo-report (copy 1).md — canonical version is in docs/orchestration/tasks/report-log/, see docs/orchestration/tasks/MIGRATION.md -->
