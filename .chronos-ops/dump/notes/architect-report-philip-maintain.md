...
по extract: `docs/orchestration/report-log/cline-report-1.md` (уже архив).
...
| Cline extract report (архив) | `docs/orchestration/report-log/cline-report-1.md` |
| Philip docs | `e485989` |
| Этот отчёт (active) | `docs/orchestration/reports/architect-report-philip-maintain.md` |
