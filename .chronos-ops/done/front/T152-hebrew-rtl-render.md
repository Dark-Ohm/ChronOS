...
**Отчёт:** `docs/orchestration/tasks/report/T152-hebrew-rtl-render-report.md`.
...
Кадр: `docs/orchestration/tasks/notes/T152-hebrew-live.png`
...
Отклонение целиком — `docs/orchestration/tasks/rejected/T152-hebrew-rtl-render-report-1.md`.
...
**Отчёт:** `docs/orchestration/tasks/report/T152-hebrew-rtl-render-report-2.md`.
