...
1. **T320** — `T320-tabs-back-to-panel.md`. P1, СВОБОДЕН.
   Вернуть девять вкладок в правую панель, снять control-center popup.
   Развилки по режиму нет — одно поведение всегда.
