...
(нарезан T324–T328). Front: T332…T337+T339+T341–T343+T345. Back: T330+T338.
**T331 HOLD.**
...
**T345 заведён 2026-08-21** (из приёмки T344): вкладка Chat рисует шапку
и композер, а **область сообщений пуста полностью** — ни сообщений, ни
«No messages yet» (`dump/qa-ux/T344/arch-solarized-chat-blank.png`).
T326-аудит в тот же день строку видел. Пока это не закрыто, левую панель
нельзя проверить визуально вообще. Второй симптом того же места: без
выбранной вкладки слой `side_panel_left_content` 920×1404 прозрачен
насквозь — плиты у панели нет.
