...
1. **T305** — settings-табы правого рейла уезжают в единый anchored
   slide-popup (control-center, видео-референс владельца). Разблокирован:
   T304 принят 2026-08-18 (`a183e86e`), `TabContent::create` берёт
   `&mut App`, popup-хост зовёт его напрямую.
2. **T303** — P2, хвост T284: развести `wrap.thickness` и
...
3. **T301** — P3, хвост T298: текст в composer Select-попапе без
   эллипсиса.
