...
Текст issue подготовлен и сохранён в `docs/orchestration/tasks/report/upstream-issue-body.md`.
...
| `docs/orchestration/tasks/report/upstream-issue-body.md` | тело issue для agentclientprotocol/rust-sdk |
