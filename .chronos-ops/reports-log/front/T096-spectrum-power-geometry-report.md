<!-- T096 — migrated 2026-07-22 from docs/orchestration/report-log/hermes-report-21.md — see docs/orchestration/tasks/MIGRATION.md -->
...
**Grim** `docs/orchestration/reports/hermes-21-smoke/`:
...
- Smoke: `docs/orchestration/reports/hermes-21-smoke/`
