<!-- T039 — migrated 2026-07-22 from docs/orchestration/report-log/zed-report-1.md — see docs/orchestration/tasks/MIGRATION.md -->
...
- `crates/app/src/updates_popup/{mod.rs,view.rs}` (новый) — layer-shell
  ...
  `follow_mouse=1` (docs/MEMORY.md 2026-07-18, отказ Cline №9) — решил не
...
IPC/askpass-слой») достойна записи в `docs/DECISIONS.log` — не стал сам,
