<!-- T088 — migrated 2026-07-22 from docs/orchestration/report-log/hermes-report-19.md — see docs/orchestration/tasks/MIGRATION.md -->
...
**grim:** `docs/orchestration/reports/hermes-19-smoke/`
...
- Smoke: `docs/orchestration/reports/hermes-19-smoke/panel-crop.png`  
