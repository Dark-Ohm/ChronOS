...
- **`6061736` project switcher (№9 закрыт Архитектором, НЕ Mimo)** —
  ...
  **НЕ дожато живьём: клик по пилюле → попап → портал-пикер** (ydotool
  промахивается, см. ограничение в roadmap) — клик-конфирм за
  пользователем, ЕДИНСТВЕННОЕ непокрытое место №9.
