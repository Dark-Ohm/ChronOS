...
`$/cancel_request`. Зонд откачен. Следующая — T144, заход 2 (убрать
процесс-глобальный статик перехвата моделей; список зависит от провайдера и
плывёт между сессиями: 287 → 36 за сутки).
