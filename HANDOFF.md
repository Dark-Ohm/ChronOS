...
**Очередь жёсткая, объявлена пользователем:** **T157** (в работе, домерить
`Input+Table` и `+VirtualList`) → **T158** (бриф ещё НЕ написан — писать по
итогам замера T157, не выдумывать заранее) → **T159** → **T160** → **T161**
→ **T162**. Все четыре задачи слайса 1 лежат в `active/`, но помечены в
