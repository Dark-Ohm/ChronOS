...
-- Single source of truth: this file is what gets installed (see
-- packaging/hyprland/README.md and hyprland.ship.lua). The former copy
-- docs/hyprland/chronos-launcher.lua was removed 2026-08-18 (T300) —
-- it had drifted into a doc-only fork with no live consumers.
--
...
--
--   dofile(os.getenv("HOME") .. "/.config/hypr/chronos/40-windowrules-chronos.lua")
--
-- after `cp packaging/hyprland/*.lua ~/.config/hypr/chronos/`, or `dofile`
-- it straight out of the repo tree. The `hl` global is provided by
-- Hyprland's Lua runtime — no import needed.
-- ======================================================================
