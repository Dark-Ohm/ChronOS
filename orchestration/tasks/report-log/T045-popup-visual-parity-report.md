<!-- T045 — migrated 2026-07-22 from orchestration/report-log/hermes-report-13.md — see orchestration/tasks/MIGRATION.md -->
...
- Архивная копия предыдущего (ошибочного) отчёта:
  `orchestration/report-log/hermes-report-12b-confusion.md`.
