...
**Дата:** 2026-07-27
**Бриф:** `orchestration/tasks/active/T146-acp-errata-after-livelock.md` (ред. 3, 20:10)
...
- `orchestration/tasks/active/T146-acp-errata-after-livelock.md` — целиком, ред. 3.
