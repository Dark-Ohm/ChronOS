<!-- T033 — SUPERSEDED draft, migrated 2026-07-22 from orchestration/report-log/opencode-report-3.md — canonical version is in orchestration/tasks/report-log/, see orchestration/tasks/MIGRATION.md -->
