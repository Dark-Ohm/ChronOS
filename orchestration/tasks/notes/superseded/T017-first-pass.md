<!-- T017 — SUPERSEDED draft, migrated 2026-07-22 from orchestration/report-log/mimo-report-4.md — canonical version is in orchestration/tasks/report-log/, see orchestration/tasks/MIGRATION.md -->
