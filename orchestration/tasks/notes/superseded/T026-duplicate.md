<!-- T026 — SUPERSEDED draft, migrated 2026-07-22 from orchestration/report-log/grok-report (copy 1).md — canonical version is in orchestration/tasks/report-log/, see orchestration/tasks/MIGRATION.md -->
